...
class CurlInternalApiClient : public InternalApiClient {
  public:
    ...
    std::optional<std::string> setMemberRole(const std::string& guild_id,
                                             const std::string& user_id, int role_rank) override;
    ...
    fetchDmConversations(const std::string& user_id) override;
    std::optional<std::vector<std::string>>
    fetchGuildIdsForUser(const std::string& user_id) override;

    std::optional<WireInvite> createInvite(const std::string& guild_id,
    ...
    fetchJoinRequests(const std::string& guild_id) override;
    ...
    AcceptFriendRequestResult acceptFriendRequest(const std::string& requester_id,
                                                  const std::string& recipient_id) override;
    bool deleteFriendRequest(const std::string& requester_id,
                             const std::string& recipient_id) override;
