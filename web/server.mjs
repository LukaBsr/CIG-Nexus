...
// (app/api/internal/*) must be reachable ONLY on a second, unpublished port
...
// it. This means the public port structurally cannot reach /api/internal/*
...
// shared-secret header /api/internal/* itself checks (design doc §9.1: the
